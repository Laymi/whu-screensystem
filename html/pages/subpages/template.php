...
<? $notizen = lade_temp_notizen($screen_design); if($notizen != "") { ?>
<br/>
<center><b>Vordefinierte (Farb-)Tags & Hinweise</b><br/ style="margin-bottom:10px;"><? echo $notizen;?></center>
<? } ?>